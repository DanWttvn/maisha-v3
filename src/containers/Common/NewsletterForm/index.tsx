...
const NewsletterForm: FC<Props> = () => (
  <Container>
    ...
    <Form action={process.env['REACT_APP_SUBSCRIBE_SENDINBLUE']} id="sib-form" method="POST" data-type="subscription" target="_blank" >
      <EmailInput placeholder="introduce tu email..." type="email" id="EMAIL" name="EMAIL" />
