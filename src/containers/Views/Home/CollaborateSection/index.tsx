...
export const CollaborateSection: FC<SectionProps> = () => {
  ...
  return (
    <Section id="collaborate">
      ...
      <SubSection id="volunteering">
        ...
        <Paragraph>
          {lang === 'ES' && <>El voluntariado es uno de los pilares de Maisha Roots y necesitamos personal voluntario, tanto en España como en Tanzania. Envíanos tu <strong>CV</strong> y una <strong>carta explicándonos tu motivación</strong> a <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink>, y estaremos encantadas/os de que te unas a nuestro equipo.</>}
          {lang === 'EN' && <>Volunteering is one of the most important roots of this organization, therefore we need volunteers to join our teams both in Spain and Tanzania. Send us your <strong>CV</strong> and a <strong>letter in which you explain to us your motivation</strong> to <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink>. We are happy that you join our team.</>}
          {lang === 'SW' && <>Kujitolea ni moja ya mzizi muhimu wa shirika hili, kwa hivyo tunahitaji kujitolea kuungana na timu zetu zote nchini Uhispania na Tanzania. Tutumie <strong>wasifu</strong> wako na <strong>barua ambayo utatuelezea motisha yako</strong> kwa <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink>. Tunafurahi kwamba unajiunga na timu yetu.</>}
        </Paragraph>
      </SubSection>
      <SubSection>
        <Subtitle>
        ...
        <Paragraph>
          {lang === 'ES' && <>Si eres <strong>estudiante de grado o de máster</strong> universitarios y estás buscando dónde realizar tus prácticas universitarias, Maisha Roots puede que sea tu sitio. Hasta el momento han participado estudiantes de grado de la Universidad Rey Juan Carlos (grados en Relaciones Internacionales, Economía, Historia, Ciencias Políticas, Comunicación Audiovisual, etc.) y de máster en la Universidad Carlos III de Madrid (Máster en Acción Solidaria Internacional e Inclusión Social), de la Universidad Politécnica de Madrid y de la Universidad Complutense de Madrid (Máster en Estrategias y Tecnologías para el Desarrollo).</>}
          {lang === 'EN' && <>If you are a university student, <strong>currently doing a degree or a masters</strong>, and you are looking for a place where to do your internship, Maisha Roots might be the correct place. Students from Rey Juan Carlos University (degrees in International, Relations, Economics, History, Political Sciences, Communication, and Media, etc.), Carlos III de Madrid University (master's in international Solidarity and Social Inclusion), and Complutense and Politécnica de Madrid Universities (master's in Strategies and Technologies for Development).</>}
          {lang === 'SW' && <>Ikiwa wewe ni mwanafunzi wa chuo kikuu, kwa sasa unafanya <strong>shahada au stashahada</strong> na unatafuta mahali pa kufanya mafunzo yako kwa vitendo, Maisha Roots inaweza kuwa ni mahali sahihi. Wanafunzi kutoka chuo kikuu cha Rey Juan Carlos (shahada ya Kimataifa, Mahusiano, Uchumi, Historia, Sayansi ya Kisiasa, Mawasiliano na Vyombo vya Habari, n.k.), Chuo kikuu cha cha Carlos III de Madrid (masta katika Ushirikiano wa Kimataifa na Ushirikiano wa Jamii), na Ushirika wa Chuo Kikuu cha Politecnica de Madrid (masta ya Mikakati na Teknolojia za Maendeleo)</>}
        </Paragraph>
        <Paragraph>
          {lang === 'ES' && <><strong>Buscamos gente comprometida que se una a nuestros equipos</strong> de Tanzania y/o España para dar apoyo en las tareas de gestión de proyectos, finanzas y contabilidad, legalidad, comunicación y redes, etc.</>}
          {lang === 'EN' && <><strong>We are looking for committed students who join our teams</strong> in Tanzania and/or Spain to support our areas of project management, finance and accounting, legality, communication and media, etc.</>}
        ...
        <Paragraph>
          {lang === 'ES' && <>Si te interesa envíanos un correo a <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink> y estudiaremos la forma de ponernos en contacto con tu universidad para realizar todos los trámites pertinentes, o si ya existiera convenio, contacta con tu gestor de prácticas para solicitar plaza en nuestras vacantes.</>}
          {lang === 'EN' && <>If you are interested, send an email to <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink> and we will contact your University to do all the paperwork, and if we already have an agreement with your University, please contact the internship manager to ask for our vacancies and the procedure to apply to it.</>}
          {lang === 'SW' && <>Ukiwa una nia, tuma barua pepe kwa <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink> na tutawasiliana na Chuo Kikuu chako, tafadhali wasiliana na msimamizi wa kitengo cha kuuliza kazi zetu na utaratibu wa kuomba ndani yake.</>}
        </Paragraph>
      ...
      <SubSection id="donate">
        ...
        <Accordion title={(lang === 'ES' && 'Haz una transferencia') || (lang === 'EN' && 'Make a transfer') || (lang === 'SW' && 'Fanya uhamishaji') || ''} isFullWidth>
          <Text styles={{ marginBottom: 8 }}>
            {lang === 'ES' && <>Puedes ayudarnos con una donación puntual. La cantidad que tú consideres será un granito de arena para nuestra sostenibilidad. Puedes hacerlo a través de <strong>transferencia bancaria o con un ingreso</strong> en la cuenta:</>}
            {lang === 'EN' && <>You can help us with a punctual donation. Any amount you consider will be very important for our sustainability. You can do it through a <strong>wire transfer or a deposit</strong> in this account:</>}
            {lang === 'SW' && <>Unaeza kushirikiana na Maisha Roots kupitia kuchangia kwa wakati. Unaeza kuchangia kwa kiasi chochote. Ikiwa unataka kuongeza kiasi chochote, unaweza kufanya kupitia uhamishaji wa fedha kielektroniki, au amana katika akauti yetu, kila kiasi ni muhimu!</>}
          </Text>
          <Container styles={{ background: theme.colors.darkRed, padding: '30px 50px', borderRadius: 30, margin: '0 auto', marginBottom: 16 }}>
            <ul>
              ...
              <li style={{ color: theme.colors.offOrange }}><Text weight="semibold">IBAN: ES55 2100 0955 8002 1028 3299</Text></li>
              <li style={{ color: theme.colors.offOrange }}><Text weight="semibold">BIC/SWIFT: CAIXESBBXXX</Text></li>
            </ul>
          </Container>
          <Text size="s" styles={{ marginBottom: 16 }}>
            {lang === 'ES' && <>Por favor, para que podamos cumplir con nuestro compromiso de transparencia, no olvide incluir en el <strong>concepto: 'donación' + nombre completo + DNI</strong>.</>}
            {lang === 'EN' && <>Please, for us to accomplish with our transparency engagement, do not forget to include in the <strong>concept: 'donation' + completed name + ID</strong>.</>}
            {lang === 'SW' && <>Tafadhali, ili tuweze kukamilisha kwa ushirika wetu wa uwazi, usisahau kujumuika kwenye <strong>dhima: 'mchango' + jina kamili + kitambulisho</strong>.</>}
          </Text>
        </Accordion>
        <Accordion title="Dona con Bizum" isHidden={lang !== 'ES'} isFullWidth>
          ...
          <Text styles={{ marginBottom: 8 }}>En caso de que quieras solicitar el certificado de donaciones, envíanos un correo a <ExternalLink href={emailHref}>info@maisharoots.org</ExternalLink>, con los siguientes datos:</Text>
          <ul>
      ...
      <SubSection>
        ...
        <Paragraph>
          {lang === 'ES' && <>Si formas parte de algún colegio o centro educativo, puedes unirte a nosotros y colaborar con un proyecto solidario. En Maisha Roots promovemos actividades entre algunos centros educativos de España, con el fin de lograr la sensibilización del alumnado respecto al continente africano, la situación en Tanzania y la importancia de la educación para el desarrollo.</>}
          {lang === 'EN' && <>If you are a member of any school or educational center, you can join us an collaborate with our projects. In Maisha Roots we promote activities in some educational centers in Spain, with the aim of achieving the sensitization of the students regarding the African continent, the situation in Tanzania and the importance of education to development.</>}
