...
const TimelineSection: FC<SectionProps> = () => {
      ...
      <SubSection isFullWidth>
        <Carousel.Container
          ...
          <Carousel.Item src="/images/photo4.webp" hasOverlay>
            ...
            <Paragraph>
              {lang === 'ES' &&
                'En 2019 empezó a funcionar, en el espacio de Chagua Maisha, un huerto ecológico de uso comunitario con el que, además, los estudiantes aprendían técnicas agrícolas. A finales de año, decidimos ceder la gestión de Chagua Maisha por completo a la contraparte local para poder emprender nuevos proyectos.'}
              {lang === 'EN' &&
              ...
              {lang === 'SW' &&
                'Mnamo mwaka 2019, bustani ya mazingira rafiki kwa matumizi ya jamii na kwa elimu ya watoto wanaohudhuria shule iliyojengwa katika eneo la Chagua Maisha. Mwisho wa mwaka huu, tulikabidhi usimamizi wa Chagua Maisha kwa washirika wa ndani. Tuliamua kuanza mradi mpya katika jamii.'}
            </Paragraph>
          </Carousel.Item>
          <Carousel.Item src="/images/photo6.jpg" hasOverlay>
            ...
            <Paragraph>
              ...
              {lang === 'SW' &&
                'Mnamo mwaka 2018, tulifanya shughuli za michezo kwa watoto zaidi ya 100 katika jamii na kukuza michezo na starehe kwa wakati wa ziada kupitia shughuli za kielimu. Kwa kuongezea, tulifungua duka ambalo liliuza bidhaa za msingi ili kusaidia katika utunzaji wa mradi.'}
            </Paragraph>
          </Carousel.Item>
          <Carousel.Item src="/images/photo5.webp" hasOverlay>
            ...
            <Paragraph>
              {lang === 'ES' &&
                'Así, a finales de 2016 y principios de 2017 levantamos un aula de pre-primaria para 25 niños y niñas en riesgo de exclusión social. También desarrollamos talleres sociales con la comunidad y comenzamos un campamento deportivo para jóvenes.'}
              {lang === 'EN' &&
              ...
              {lang === 'SW' &&
                'Mnamo mwaka 2017, tulifungua darasa la pili na tukajenga nafasi ya umma ambapo sinema zilifanyika, chakula kilipatikana, michezo ya mezani na vitabu vilikuzwa. Lengo kuu la nafasi kuu ya umma ilikuwa kuunda hali ya jamii na mtandao katika jamii inayokua.'}
            </Paragraph>
            <Paragraph>
              {lang === 'ES' &&
          ...
          <Carousel.Item src="/images/photo3.webp" hasOverlay>
            ...
            <Paragraph>
              ...
              {lang === 'SW' &&
                "Kutokea mwaka 2016 hadi 2019, tulishirikiana na Progress for Africa NGO ya Tanzania kwa mradi unaoitwa 'Chagua Maisha' ambao unamaanisha (choose life) 'Chagua Maisha' kwa Kiswahili. Kwa ushirikiano huu, tulianzisha miradi kadhaa ya ushirikiano wa maendeleo, tulilenga kuchangia katika uboreshaji wa wanufaika wa Born City, mtaa unaokuwa na ufikiaji mdogo wa mahitaji ya kijamii."}
            </Paragraph>
          </Carousel.Item>
