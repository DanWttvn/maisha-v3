...
export const ProjectsSection: FC<SectionProps> = () => {
  ...
  return (
    <Section id="projects">
      <Title
        firstPart={(lang === 'ES' && 'QUÉ') || (lang === 'EN' && 'WHAT') || (lang === 'SW' && 'TUNAFANYA') || ''}
        secondPart={(lang === 'ES' && 'HACEMOS') || (lang === 'EN' && 'WE DO') || (lang === 'SW' && 'NINI') || ''}
      />
      ...
      <SubSection>
        ...
        <Paragraph>
          {lang === 'ES' && 'Además de incluir la perspectiva de género en el desarrollo de todos nuestros proyectos, apoyamos la creación de clubs de debate en los centros educativos del distrito de Ward, abordando temas como la desigualdad, la violencia o la salud sexual y reproductiva de las mujeres. Internamente, llevamos a cabo formaciones en materia de igualdad de género tanto para el personal tanzano como para el personal español.'}
          {lang === 'EN' && 'In addition to including the gender perspective in the development of all our projects, we support the creation of discussion clubs in the educational centers of the Terrat ward, addressing issues such as inequality, violence, or women\'s sexual and reproductive health. Internally, we conduct gender equality training for both Tanzanian and Spanish teams.'}
          {lang === 'SW' && 'Tunahusisha mtazamo wa kijinsia katika mchakato wa utekelezaji wa miradi yetu yote, tunaunga mkono uundwaji wa vilabu vya majadiliano katika vituo vya kielimu katika kata ya Terrat, wakizungumzia masuala kama usawa, ukatili au afya ya uzazi kwa wanawake. Ndani ya shirika tunafanya mafunzo ya kijinsia kwa tumu ya Tanzania na Uhispania.'}
        </Paragraph>
        ...
        <Paragraph>
          ...
          {lang === 'SW' && 'Kila wiki tunatoa masomo ya ziada kwa wanafunzi wa shule ya Mkonoo, kuchangia kupunguza wanafunzi kufeli katika mkoa wa Arusha. Wanafunzi wanaoshiriki wanachaguliwa na walimu wenyeji kwa kushirikiana na shirika na vipindi vinafanywa na walimu kutoka Maisha Roots'}
        </Paragraph>
        ...
        <Paragraph>
          {lang === 'ES' && 'Para contribuir al desarrollo socioeconómico de la comunidad, ofrecemos a la población de Terrat talleres sobre técnicas de cultivo que mejoren la productividad de las tierras. Estos cursos se desarrollan en un terreno alquilado por Maisha Roots para que las personas beneficiarias puedan poner en práctica los conocimientos adquiridos.'}
          {lang === 'EN' && 'To contribute to the socio-economic development of the community, we offer the people of Terrat workshops on cultivation techniques that improve the productivity of the land. These courses take place on land rented by Maisha Roots so that the beneficiaries can put the acquired knowledge into practice.'}
          {lang === 'SW' && 'Ili kuchangia katika maendeleo ya uchumi wa kijamii, tunatoa mafunzo kwa watu wa Terrat kuhusu mbinu bora za kilimo ambazo zitaboresha mavuno shambani. Mafunzo haya yanafanyika katika shamba lililokodiwa na Maisha Roots ili wanufaika waweze kufanya walichojifunza kwa vitendo.'}
        </Paragraph>
