  ...
  return (
    <Section id="about">
      ...
      <SubSection>
        ...
        <Paragraph styles={{ borderLeft: `0.625rem solid ${light.colors.offRed}`, paddingLeft: 40 }}>
          {lang === 'ES' && <>Los medios de vida y la educación son herramientas que contribuyen a la<strong> autonomía, independencia y empoderamiento </strong>de las personas. Además, a través de los medios de vida y de la educación se consolidan valores, dinámicas e iniciativas que responden a las demandas y deseos de la población. Por ello, Maisha Roots se centra en fomentar la capacidad y los recursos pertinentes para la <strong> construcción del bienestar común, la evolución y el desarrollo.</strong></>}
          {lang === 'EN' && <>Livelihood and education are two tools that contribute to the<strong> autonomy, independence, and empowerment </strong>of people. Moreover, education and livelihood strengthen values, dynamics, and initiatives that answers other population demands and wishes. Therefore, Maisha Roots focuses on fostering the capacity and resources for the<strong> construction of common well-being, evolution, and development.</strong></>}
      ...
      <SubSection id="context" isNarrow>
        ...
        <DataParagraph styles={{ width: '65%', marginBottom: 30, marginRight: 'auto' }}>
          {lang === 'ES' && <>Arusha es una gran ciudad y un importante centro diplomático internacional. Es una ciudad caracterizada por su <Text isHighlighted> multiculturalidad</Text>, poblada por tanzanos de distintos orígenes, bantús, árabes e indios, aunque también hay minorías europeas y americanas.</>}
          {lang === 'EN' && <>Arusha is a big city and an important international diplomatic center. It is a city characterized by its <Text isHighlighted> multiculturalism</Text>, populated by Tanzanian from different origins, Bantus, Arabs, and Indians, though also by Caucasic minorities from Europe and North America.</>}
          {lang === 'SW' && <>Arusha ni jiji kubwa na kituo muhimu cha kidiplomasia. Ni mji unaoonyeshwa na <Text isHighlighted> tamaduni zake nyingi</Text>, zilizokusanywa na Watanzania kutoka asili tofauti, za kibantu, kiarabu na kihindi, ingawa pia na wachache kidogo wa Caucasic kutoka Ulaya na Amerika ya Kaskazini.</>}
        </DataParagraph>

        <DataParagraph styles={{ width: '65%', marginLeft: 'auto', textAlign: 'end', marginBottom: 30 }}>
          {lang === 'ES' && <>Arusha es una ciudad <Text isHighlighted>en expansión</Text>, por lo que cuenta con muchos barrios que están en continuo y rápido crecimiento y, por tanto, carecen de recursos básicos. Es aquí donde intentaremos centrar <Text isHighlighted>nuestra acción</Text>.</>}
          {lang === 'EN' && <>Arusha is a <Text isHighlighted>sprawling city</Text>, this is why many of its neighborhoods are in continuous and fast growth, therefore they lack minimum services. Here is where we try to focus on{' '} <Text isHighlighted>our actions</Text>.</>}
          {lang === 'SW' && <>Arusha ni <Text isHighlighted>mji unaofurika</Text>, ndio maana vitongoji vyake vingi vinaendelea kuongezeka watu kwa kasi, hivyo basi wanakosa huduma za msingi. Hapa ndipo tunapotilia mkazo{' '} <Text isHighlighted>utendaji wetu</Text>.</>}
        </DataParagraph>
        ...
        <Container direction="vertical" styles={{ marginBottom: 30 }}>
          <DataText>77,9<span style={{ fontSize: '5rem' }}>%</span></DataText>
          <Text>
        ...
        <DataParagraph styles={{ width: '65%', marginLeft: 'auto', textAlign: 'end', marginBottom: 30 }}>
          {lang === 'ES' && <>Por otro lado, las tasas de desempleo en medios oficiales no registran números muy elevados, pero la realidad, en especial en las grandes ciudades como Arusha, es que las y los jóvenes que abandonan sus estudios, especialmente durante o al finalizar la secundaria, se encuentran en situación de <Text isHighlighted>desempleo</Text> y <Text isHighlighted>sin tecnificaciones necesarias</Text> para encontrar un buen empleo o empezar un negocio.</>}
          {lang === 'EN' && <>Kwa upande mwingine, kiwango cha ukosefu wa ajira katika vyombo vya habari rasmi na taasisi za umma sio za idadi kubwa, lakini kwa hali halisi, hasa katika miji mikubwa kama Arusha, vijana ambao wameacha shule, haswa katika elimu ya sekondari au waliomaliza kwa wakati, <Text isHighlighted>unemployed </Text>and <Text isHighlighted>without the necessary qualifications</Text> to find a proper job or start a business.</>}
        ...
        <BorderedBox>
          <Text>
            ...
            {lang === 'EN' && <>These are the main areas where Maisha Roots aims to influence and change this reality, putting its <strong>beneficiaries in the center</strong> of each intervention, using a <strong>participatory approach</strong> in all its actions, and making people become their own main <strong>protagonist</strong> of change and <strong>life promotion</strong>.</>}
