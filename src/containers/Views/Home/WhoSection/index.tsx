...
const WhoSection: FC<SectionProps> = () => {
    ...
    <Section id="about">
      ...
      <SubSection>
        ...
        <Paragraph>
          ...
          {lang === 'ES' && (
            <>
              El nombre Maisha Roots procede de la palabra swahili
              <strong> 'maisha'</strong>, que significa vida, y de la palabra
              inglesa<strong> 'roots',</strong> que significa raíces formando la
              expresión 'raíces de vida '. Y representa los dos pilares de
              actuación de la organización: la educación y los medios de vida.
            </>
          )}
          {lang === 'EN' && (
            <>
              The name Maisha Roots comes from the Swahili word
              <strong> 'maisha'</strong>, which means life, and the English word
              <strong> 'roots'</strong>, forming the expression 'life roots '.
              It represents the two main action pillars of the organization:
              education and livelihood.
            </>
          )}
          {lang === 'SW' && (
            <>
              Jina Maisha Roots linatokana na neno la Kiswahili '
              <strong> 'maisha'</strong>, na neno la Kingereza
              <strong> 'roots' </strong>(mzizi), huunda usemi 'Maisha Roots '.
              Inawakilisha nguzo kuu mbili za shirika: elimu na uinuaji wa
              maisha.
            </>
          )}
          <br />
          ...
          {lang === 'ES' && (
            <>
              Entendemos<strong> ‘medios de vida’</strong> como toda aquella
              actividad que desarrolla el aspecto productivo de una persona, a
              través de la cual obtiene experiencia y remuneración. Y entendemos
              la <strong> ‘educación’</strong> como toda formación destinada a
              desarrollar la capacidad intelectual, moral y afectiva de una
              persona y como el derecho de toda la ciudadanía a una enseñanza
              básica gratuita.
            </>
          )}
          {lang === 'EN' && (
            <>
              We understand<strong> ‘livelihood’</strong> as every activity
              developing the productive aspect of a person, through which the
              person obtains experience and remuneration. We understand{' '}
              <strong> ‘education’</strong>as every training or formation
              dedicated to developing the intellectual, moral, and affective
              capacity of a person as well as the civil right to receive basic
              and free education.
            </>
          )}
          {lang === 'SW' && (
            <>
              Tunaelewa<strong> ‘uinuaji wa maisha’</strong> kama kila shughuli
              inayokuza hali ya uchumi wa mtu, ambayo kupitia yeye mtu hupata
              uzoefu na ujira. Tunaelewa<strong> ‘elimu’</strong> kama mafunzo
              yote yanayolenga kumletea maendeleo mtu kifikra, kimaadili na
              uwezo wa kihisia kama haki ya kila raia kupata elimu ya msingi na
              ya bure.
            </>
          )}
        </Paragraph>
        <Paragraph
          ...
          {lang === 'ES' && (
            <>
              ...
              a la<strong> autonomía, independencia y empoderamiento </strong>de
              las personas. Además, a través de los medios de vida y de la
              educación se consolidan valores, dinámicas e iniciativas que
              responden a las demandas y deseos de la población. Por ello,
              Maisha Roots se centra en fomentar la capacidad y los recursos
              pertinentes para la{' '}
              <strong>
                {' '}
                construcción del bienestar común, la evolución y el desarrollo.
              </strong>
            </>
          )}
          {lang === 'EN' && (
            <>
              ...
              <strong> autonomy, independence, and empowerment </strong>of
              people. Moreover, education and livelihood strengthen values,
              dynamics, and initiatives that answers other population demands
              and wishes. Therefore, Maisha Roots focuses on fostering the
              capacity and resources for the
              <strong>
                {' '}
                construction of common well-being, evolution, and development.
              </strong>
            </>
          )}
          {lang === 'SW' && (
            <>
              ...
              <strong> uhuru, kujitegemea na uwezeshaji </strong>wa watu. Kwa
              kuongezea, elimu na uinuaji wa maisha huimarisha maadili na
              mipango ambayo inajibu mahitaji na matakwa ya watu wengine. Kwa
              hivyo, Maisha Roots inalenga katika kukuza uwezo na rasilimali
              kwaajili ya
              <strong>
                {' '}
                ujenzi wa ustawi wa kawaida, uvumbuzi na maendeleo.
              </strong>
            </>
          )}
        </Paragraph>
      ...
      <SubSection id="context" isNarrow>
        ...
        <Container direction="vertical" styles={{ marginBottom: 30 }}>
          <DataText>
            77,9<span style={{ fontSize: '5rem' }}>%</span>
          </DataText>
          <Text>
        ...
        <DataParagraph
          ...
          {lang === 'ES' && (
            <>
              ...
              registran números muy elevados, pero la realidad, en especial en
          ...
          {lang === 'EN' && (
            <>
              Kwa upande mwingine, kiwango cha ukosefu wa ajira katika vyombo
        ...
        <BorderedBox>
          <Text>
            {lang === 'ES' && (
              <>
                Es en estos ámbitos en los que Maisha Roots pretende incidir y
                transformar esta realidad, situando a las{' '}
                <strong>personas beneficiarias en el centro</strong> de cada
                intervención, empleando un{' '}
                <strong>enfoque participativo</strong> en todas sus acciones, y
                haciendo <strong>protagonistas</strong> de cambio y{' '}
                <strong>evolución</strong> a las personas.
              </>
            )}
            {lang === 'EN' && (
              <>
                These are the main areas where Maisha Roots aims to influence
                and change this reality, putting its{' '}
                <strong>beneficiaries in the center</strong> of each
                intervention, using a <strong>participatory approach</strong> in
                all its actions, and making people become their own main{' '}
                <strong>protagonist</strong> of change and{' '}
                <strong>life promotion</strong>.
              </>
            )}
            {lang === 'SW' && (
              <>
                Haya ndo maeneo makubwa ambayo Maisha Roots inasaidia kushawishi
                na kubadili uhalisia huu, kuweka walengwa wake katikati kwa kila
                upande, kwa kutumia <strong>njia shirikishi</strong> katika
                shughuli zake zote, na kuwafanya watu kuwa{' '}
                <strong>wahusika wakuu</strong> wa mabadiliko na{' '}
