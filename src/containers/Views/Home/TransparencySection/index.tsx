...
export const TransparencySection: FC<SectionProps> = () => {
  ...
  const docSrcs = {
    managmentOfConflicts: "/images/docs/Mecan%C3%ADsmo_de_gesti%C3%B3n_de_conflictos_de_inter%C3%A9s-Maisha_Roots.pdf",
    responsibleSelection: "/images/docs/Criterios_de_selecci%C3%B3n_de_colaboradores_y_contrapartes-Maisha_Roots.pdf",
    expensesAproval: "/images/docs/Aprobaci%C3%B3n_de_gastos_y_selecci%C3%B3n_de_proveedores-Maisha_Roots.pdf",
    ...
    <Section id="transparency">
      ...
      <SubSection id="good-practices">
        ...
        <ul style={{ marginBottom: 16 }}>
          <Li>
            {lang === 'ES' && <ExternalLink href={docSrcs.managmentOfConflicts}>Gestión de conflictos de interés en el órgano de gobierno</ExternalLink>}
          ...
          <Li>
            {lang === 'ES' && <ExternalLink href={docSrcs.responsibleSelection}>Selección responsable de contrapartes y colaboradores</ExternalLink>}
            {lang === 'EN' && 'Responsible selection of partners and collaboration'}
            {lang === 'SW' && 'Uwajibikaji wa uteuzi wa washirika'}
          </Li>
          <Li>
            {lang === 'ES' && <ExternalLink href={docSrcs.expensesAproval}>Aprobación razonada de gastos y proveedores</ExternalLink>}
            {lang === 'EN' && 'Reasoned approval of expenses and suppliers'}
            {lang === 'SW' && 'Uidhinishwaji wa gharama na usambazaji'}
          </Li>
          <Li>
            {lang === 'ES' && <ExternalLink href={docSrcs.donationsControl}>Control de Donaciones</ExternalLink>}
      ...
      <SubSection id="reports">
        ...
        <ParagraphDocs>
          ...
          <ExternalLink href="/images/docs/Dossier_es_2017-MR.pdf">ESP</ExternalLink>
        ...
        <ParagraphDocs>
          ...
          <ExternalLink href="/images/docs/Memoria_de_Actividades2016-2017-MR.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          {lang === 'ES' && 'Dossier 2018'}
          {lang === 'EN' && 'Dossier 2018'}
          {lang === 'SW' && 'Dossier 2018'}
          <ExternalLink href="/images/docs/Dossier_es_2018-MR.pdf">ESP</ExternalLink>
        ...
        <ParagraphDocs>
          ...
          <ExternalLink href="/images/docs/Memoria_de_Actividades2017-2018-MR.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          {lang === 'ES' && 'Memoria actividades 2019'}
          {lang === 'EN' && 'Report of Activities 2019'}
          {lang === 'SW' && 'Ripoti ya Shughuli 2019'}
          <ExternalLink href="/images/docs/Memoria_de_Actividades2019-MR.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          {lang === 'ES' && 'Memoria actividades 2020'}
          {lang === 'EN' && 'Report of Activities 2020'}
          {lang === 'SW' && 'Ripoti ya Shughuli 2020'}
          <ExternalLink href="/images/docs/Memoria_de_Actividades2020-MR.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          {lang === 'ES' && 'Estatutos Maisha Roots Spain'}
          {lang === 'EN' && 'Maisha Roots Spain Constitution'}
          {lang === 'SW' && 'Katiba ya Maisha Roots Spain'}
          <ExternalLink href="/images/docs/estatutos-Maisha_Roots_Spain.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          {lang === 'ES' && 'Constitución FYWCO'}
          {lang === 'EN' && 'FYWCO Constitution'}
          {lang === 'SW' && 'Katiba ya FYWCO'}
          <ExternalLink href="/images/docs/FYWCO_constitution.pdf">ENG</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
        ...
        <ParagraphDocs>
          ...
          <ExternalLink href="/images/docs/plan_de_voluntariado-Maisha_Roots.pdf">ESP</ExternalLink>
        </ParagraphDocs>
        <ParagraphDocs>
          ...
          <ExternalLink href="/images/docs/utilidad_publica.pdf">ESP</ExternalLink>
        </ParagraphDocs>
      </SubSection>
    </Section>
  )
