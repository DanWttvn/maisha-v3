  ...
  return (
    <SubSection>
      ...
      <Accordion title="¿Qué significa ser socio/a de Maisha Roots?" isFullWidth>
        ...
        <ul>
          <li><Text>Seguir apoyando, por muchos años más, a las más de 100 personas beneficiarias de nuestros proyectos en la comunidad de Arusha, Tanzania, donde trabajamos.</Text></li>
          <li><Text>Aumentar el alcance de nuestro Proyecto Mawio y su continuación en el tiempo</Text></li>
          <li><Text>Sacar adelante futuros proyectos</Text></li>
          <li><Text>Potenciar nuestra sostenibilidad</Text></li>
        </ul>
      </Accordion>
